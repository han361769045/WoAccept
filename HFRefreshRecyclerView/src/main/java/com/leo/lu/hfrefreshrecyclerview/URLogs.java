...
public final class URLogs {
    ...
    private static String getContent(StackTraceElement trace) {
        return String.format(Locale.CHINESE, TAG_CONTENT_PRINT, sApplicationTag,
                trace.getClassName(), trace.getMethodName(),
                trace.getLineNumber());
    }

    private static String getContents(StackTraceElement trace) {
        return String.format(Locale.CHINESE, "%s:%s:%d", sApplicationTag,
                trace.getMethodName(),
                trace.getLineNumber());
    }
    ...
    private static void traceStack(String tag, int priority) {
