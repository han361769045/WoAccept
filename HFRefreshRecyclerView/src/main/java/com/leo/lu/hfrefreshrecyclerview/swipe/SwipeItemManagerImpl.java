...
public class SwipeItemManagerImpl implements SwipeItemManagerInterface {
    ...
    private void initialize(HFRefreshRecyclerViewViewHolder targetViewHolder, int position) {
    ...
    public void updateConvertView(HFRefreshRecyclerViewViewHolder targetViewHolder, int position) {
