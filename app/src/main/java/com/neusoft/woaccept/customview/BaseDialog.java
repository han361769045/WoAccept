...
import com.neusoft.woaccept.animator.BaseAnimatorSet;
import com.neusoft.woaccept.tools.StatusBarUtils;
...
//        params.alpha = 0.0f;
        ...
        params.width = WindowManager.LayoutParams.WRAP_CONTENT;//(int) (160 * density);
        params.height = WindowManager.LayoutParams.WRAP_CONTENT;//(int) (120 * density);
